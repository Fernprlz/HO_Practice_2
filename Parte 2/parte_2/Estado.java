...
// Definimos el criterio que usar� Collections.sort para ordenar la ArrayList de estados.
// Esta funci�n implementa mergeSort.
class ByHeuristics implements Comparator<Estado> {

	/**
	 * Compara dos Estados seg�n su heur�stica devolviendo la diferencia del primero con el segundo.
	 */
